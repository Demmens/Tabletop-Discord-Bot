...
class RpCommand extends Command {
	...
	async exec(message, args) {
		...
		if (message.channel.id != 719323871580258376){
			let msg = await message.channel.send('Please keep bot usage in '+ message.guild.channels.fetch('719323871580258376').toString());
			message.delete();
		...
		if (!isRP){
			return message.channel.send('You must have the Roleplay role to use this command. React to the bot in ' + message.guild.channels.fetch('704330819392766035').toString() + ' to get the role.');
		}
